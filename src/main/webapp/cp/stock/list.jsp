...
<head>
    ...
    <%@include file="/cp/head/bootstrap-datepicker-css.jsp"%>

    <!-- DataTables -->
    <%@include file="/cp/head/data-tables.jsp"%>

    <!-- Responsive datatable examples -->
    <%@include file="/cp/head/responsive-datatable-examples.jsp"%>
...
<body data-sidebar="dark">
    ...
    <%@include file="/cp/script/bootstrap-datepicker-js.jsp"%>
